...
pub mod profile {
    ...
    pub mod about {
        ...
        pub fn equals(value: String) -> WhereParam {
            WhereParam::About(_prisma::read_filters::StringFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::StringFilter,
            About,
    ...
    pub fn create(
        ...
        (about, created_at, user, username, url, _params)
    }
    pub fn create_unchecked(
        id: i32,
        about: String,
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_profile { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: profile struct $ struct_name { # [serde (rename = "id")] pub id : i32 , # [serde (rename = "about")] pub about : String , # [serde (rename = "created_at")] pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "username")] pub username : String , # [serde (rename = "url")] pub url : String } [$ ($ scalar_field) , +] } } ; }
    ...
    pub enum WhereParam {
        ...
        And(Vec<WhereParam>),
        Id(_prisma::read_filters::IntFilter),
        About(_prisma::read_filters::StringFilter),
        CreatedAt(_prisma::read_filters::DateTimeFilter),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(id, about, created_at, username, url, mut _params)| {
                    _params.extend([
                        id::set(id),
                        about::set(about),
                        created_at::set(created_at),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (about, created_at, user, username, url, mut _params): (
                String,
                ::prisma_client_rust::chrono::DateTime<::prisma_client_rust::chrono::FixedOffset>,
                super::user::UniqueWhereParam,
                String,
