  ...
  return (
    <PageContent className="!pt-0 !px-0 lg:!pb-4 lg:!px-4">
      <div className="flex flex-col">
        <div className="h-[180px] w-full bg-base-muted-foreground px-4">
          <Tabs
        ...
        <div className="relative flex flex-col bg-base-background gap-6 -mt-4 overflow-hidden rounded-t-[24px] p-4 w-full">
          <div className="flex flex-col gap-4">
            <div className="flex w-full gap-4">
              <div className="flex gap-3 w-full">
                <Avatar src={community.logo} className="!size-[78px]" />
                <div className="flex flex-col gap-2.5">
                  <h1 className="text-card-foreground font-inter font-semibold text-xl leading-5 lg:max-w-[270px] line-clamp-2">
                    {community.name}
                  </h1>
                  <span className="text-base-muted-foreground font-inter font-medium text-xs">
